...
import{A as k,B as O,E as S,I as y,L as P,a as h,b as r,c,d,e as s,f as v,g as C,h as u,i as n,j as e,k as t,l as p,m as f,n as M,o as w,p as a,q as b,v as _,y as x}from"./chunk-KVFGRMQ5.mjs";var E=(o,l)=>l.title,L=()=>({title:"Explore the Docs",link:"https://angular.dev"}),T=()=>({title:"Learn with Tutorials",link:"https://angular.dev/tutorials"}),V=()=>({title:"CLI Docs",link:"https://angular.dev/tools/cli"}),D=()=>({title:"Angular Language Service",link:"https://angular.dev/tools/language-service"}),I=()=>({title:`Angular\r
  ...
  }`]})};var Z=[];var F={providers:[_({eventCoalescing:!0}),P(Z),O()]};var G={providers:[S()]},H=x(F,G);var B=()=>k(m,H),c1=B;export{c1 as a};
